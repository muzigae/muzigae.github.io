...
<br>순서대로 해결해보자. 이해를 위해 아래의 테스트 케이스로 단계별 지도의 모습을 살펴볼 것이다.
{% highlight C++ %}
13 40
...
지도 크기 조건에 의해 섬의 개수가 2500개를 넘을 수 없으므로 위 코드에서는 바다를 2500으로 저장했다.<br><br>
...
<img src = "/assets/img/post_img/BOJ1109_label.png"/>
<br><br>
...
{% endhighlight %}
이번 BFS에서는 방문한 섬과 바다를 구별하기 위해 방문한 지점을 바다와도 섬의 번호와도 겹치지 않는 값을 저장해준다.<br>
다음은 2단계 이후 지도의 모습이다. 바다를 공백으로, 탐색한 바다는 '#'으로 표시하였다.<br><br>
&nbsp;1번 섬<br>
<img width = 360 src = "/assets/img/post_img/BOJ1109_1.png"/><br><br>
&nbsp;4번 섬<br>
<img width = 360 src = "/assets/img/post_img/BOJ1109_4.png"/><br><br>
&nbsp;5번 섬<br>
<img width = 360 src = "/assets/img/post_img/BOJ1109_5.png"/><br><br>
...
{% endhighlight %}
<img src = "/assets/img/post_img/BOJ1109_height.png"/><br>
마지막으로 위에서 얻은 결과를 통해 각 섬의 높이를 계산한다.<br>
섬의 최외곽 섬을 따라가면서 높이를 갱신하도록 구현했다. 재귀와 DFS를 사용하는 방법도 있다.
